...
interface SummaryData {
  ...
  penaltyGoals: HandballEvent[];

  ownGoals: HandballEvent[];

  yellowCards: HandballEvent[];

  redCards: HandballEvent[];
...
export default function HandballSummaryPage() {
  ...
  async function loadSummary() {
    try {
      ...
      try {
        ...
        if (liveResponse.ok) {
          const liveResult: LiveHandballData =
        ...
        console.warn(
          "Could not load live handball events:",
          liveError
        );
      }
      ...
      const summaryEvents: HandballEvent[] =
      ...
      // MERGE EVENTS
      //
      // The summary API is the source of truth.
      // Live data only fills additional details.
      //
      // If an event was deleted, it will NOT exist in
      // summaryEvents and therefore cannot appear here.
      // =================================================
      ...
      //
      // IMPORTANT:
      // Only GOAL is counted as a normal goal.
      //
      // PENALTY GOAL is NOT included.
      // =================================================
      ...
      //
      // PENALTY GOAL does NOT count here.
      // OWN GOAL does NOT count here.
      // =================================================
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl border bg-white p-12 text-center shadow-sm">
            <p className="text-sm text-slate-500">
              Loading handball match summary...
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl border border-red-200 bg-white p-12 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">
              {error ||
                "Handball summary not available."}
            </p>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Handball events recorded for both teams
              </p>
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Successfully converted penalty throws
              </p>
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Penalty throws that were not converted
                </p>
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Every handball event recorded during the match
            </p>
