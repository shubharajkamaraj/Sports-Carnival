...
export default function FootballPointsTablePage() {
  const router = useRouter();

  const [standings, setStandings] = useState<FootballTeamStanding[]>([]);
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={() =>
                    router.push("/admin/points-table")
                  }
        ...
        {!loading && !error && standings.length > 0 && (
          <section className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <SummaryCard
              ...
              value={getTotalMatches(standings)}
            ...
            <SummaryCard
              icon={<Trophy size={18} />}
              label="Total Points"
              value={getTotalPoints(standings)}
          ...
          standings.length === 0 && (
            <section className="mt-5 rounded-3xl border border-slate-800 bg-slate-900/50 p-10 text-center">
              ...
              <h2 className="mt-4 text-lg font-black">
                No Football Matches Yet
              </h2>

              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                Once completed football matches are available,
                the team standings will automatically appear here.
              </p>
