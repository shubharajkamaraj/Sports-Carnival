...
type PointsTableTeam = {
  ...
  /*
   * Throwball-specific values.
   *
   * These can be calculated by the API.
   */
  setsWon?: number;
  setsLost?: number;
...
export default function ThrowballPointsTablePage() {
  /* =======================================================
     STATE
  ======================================================= */
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-12 text-center">
            ...
            <p className="mt-4 text-sm font-semibold text-slate-400">
              Loading Throwball points table...
            </p>
  ...
  return (
    <main className="min-h-screen bg-slate-950 p-4 text-white md:p-6">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-br from-orange-950/40 via-slate-900 to-slate-950">
            ...
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Ranked by points and set difference
                </p>
          ...
          {teams.length === 0 ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="mt-4 text-sm font-bold text-slate-300">
                No completed Throwball matches
              </h3>

              <p className="mt-1 text-xs text-slate-500">
                The points table will appear once
                Throwball matches are completed.
              </p>
                      ...
                      (team) => {
                        ...
                        return (
                          ...
                          >
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  {isFirst && (
                                    ...
                                    <p className="mt-0.5 text-[9px] font-black uppercase tracking-wider text-orange-400">
                                      Top position
                                    </p>
                            ...
                            <td className="px-3 py-5 text-center text-sm font-bold text-emerald-400">
                              {team.setsWon ?? 0}
                            </td>
                            ...
                            <td className="px-4 py-5 text-center">
                              ...
                              <span className="inline-flex min-w-10 items-center justify-center rounded-lg bg-orange-500/10 px-2.5 py-1.5 text-sm font-black text-orange-400">
                                {team.points}
                              </span>
