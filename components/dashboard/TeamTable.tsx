    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.98]"
        >
          <Plus size={17} />
      ...
      <div className="relative max-w-sm">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-200 bg-white py-2.5 pl-10 pr-3 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-50"
        />
      ...
      {!loading &&
        filteredTeams.length === 0 && (
          <div className="flex min-h-[250px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white">
            ...
            {filteredTeams.map((team) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="h-1 bg-gradient-to-r from-blue-700 via-yellow-500 to-blue-700" />

                  {/* ================================================= */}
                  {/* LOGO */}
                  {/* ================================================= */}

                  <div className="relative flex h-[145px] items-center justify-center overflow-hidden bg-slate-950">
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-center">
                      ...
                      <h2 className="truncate text-lg font-black uppercase tracking-wide text-slate-900">
                        {team.name}
                      </h2>
                    ...
                    <div className="mt-2.5 flex items-center justify-between rounded-xl border border-slate-100 bg-white px-2.5 py-2">

                      <span className="text-[9px] font-semibold uppercase tracking-wider text-slate-400">
                        Game
                      </span>

                      <span className="max-w-[100px] truncate rounded-full bg-blue-50 px-2 py-1 text-[10px] font-bold text-blue-700">
                        {team.game}
                      </span>
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-green-200 bg-green-50 px-2 py-2 text-xs font-semibold text-green-700 transition hover:bg-green-100"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-2 py-2 text-xs font-semibold text-red-600 transition hover:bg-red-100"
                      >
