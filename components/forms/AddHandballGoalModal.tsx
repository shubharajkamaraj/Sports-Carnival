...
export default function AddHandballGoalModal({
  open,
  matchId,
  team,
  allPlayers,
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const res = await fetch(
        `/api/matches/${matchId}/handball/events`,
        {
          method: "POST",
      ...
      try {
        ...
        console.error(
          "HANDBALL GOAL API returned non-JSON:",
          responseText
        );
      ...
      if (!res.ok) {
        throw new Error(
          data.error ||
            data.message ||
            "Failed to record handball goal."
        );
      }
      ...
      toast.success(
        "Handball goal recorded successfully."
      );
